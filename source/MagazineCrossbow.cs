...
public class MagazineCrossbowClient : RangeWeaponClient
{
    ...
    {
        switch ((MagazineCrossbowState)state)
        {
            case MagazineCrossbowState.OpenLid:
            case MagazineCrossbowState.ReadyToLoad:
            case MagazineCrossbowState.Load:
            case MagazineCrossbowState.CloseLid:
                RangedWeaponSystem.SendStatusChange(player, RangedWeaponStatus.EndLoading, mainHand);
                break;
            case MagazineCrossbowState.Ready:
            case MagazineCrossbowState.Shoot:
            case MagazineCrossbowState.Shot:
            case MagazineCrossbowState.Return:
    ...
    protected virtual bool CloseLid(ItemSlot slot, EntityPlayer player, ref int state, ActionEventData eventData, bool mainHand, AttackDirection direction)
    {
        ...
        AnimationBehavior?.Play(mainHand, Stats.CloseLidAnimation, callback: () => CloseLidCallback(slot, player, mainHand), animationSpeed: GetAnimationSpeed(player, Stats.ProficiencyStat) * stackStats.ReloadSpeed * Stats.ReloadAnimationSpeed);
    ...
    protected virtual bool CloseLidCallback(ItemSlot slot, EntityPlayer player, bool mainHand)
    {
    ...
    protected virtual bool Shoot(ItemSlot slot, EntityPlayer player, ref int state, ActionEventData eventData, bool mainHand, AttackDirection direction)
    {
        ...
        AnimationBehavior?.Play(mainHand, Stats.ShootAnimation, animationSpeed: GetAnimationSpeed(player, Stats.ProficiencyStat) * stackStats.ReloadSpeed, callback: () => ShootCallback(slot, player, mainHand));
